...
public class MatikanListrik_18523158 extends PApplet {
...
public void draw(){
  ...
  if(frameCount < 480){
    ...
    scene5();
    volMusic = volMusic >= 0 ? volMusic - 0.005f : 0;
    musik.amp(volMusic);
    //gelap
...
public void scene1(){
  ...
  if(frameCount >= 1400){
    ...
    if(xKipas >= width/2 + 20){
      xKipas =  width/2 + 20;
      if(frameCount % 10 == 0){
        kecepatanRotasi = kecepatanRotasi * 0.5f;
      }
      rotasiKipas = (frameCount%360)*kecepatanRotasi;
    }
  }
...
public void garisPutih(float xGaris){
  pushMatrix();
    //batang
    fill(255);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MatikanListrik_18523158" };
    if (passedArgs != null) {
